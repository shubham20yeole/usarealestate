...
var db = mongojs('mongodb://xxxxxxxx.xxxxxxxx:xxxxxxxx.xxxxxxxx@xxxxxxxx.mlab.com:xxxxxxxx/xxxxxxxx', collections)
       ...
       var newNotification = {
        ...
        db.property.insert(newProperty, function(err, result){
          if(err){
            ...
            setTimeout(function(){ 
            res.redirect('http://usa-real-estates.herokuapp.com/detailedproperty/'+result.timestamp);
            }, 5000);
          }
      });
});
